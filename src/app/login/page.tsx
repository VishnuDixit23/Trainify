...
const LoginPage = () => {
  ...
  return (
    <motion.div
      className="flex h-screen w-full bg-gray-100 dark:bg-gray-900"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      {/* Left Side */}
      <div className="w-1/2 flex flex-col justify-center items-center bg-white dark:bg-gradient-to-br from-stone-300 to-stone-500 p-12">
        <h1 className="text-5xl font-extrabold text-black dark:text-white leading-tight text-center">
          TRAINIFY <span className="text-stone-800">POWERED BY</span> AN AI TRAINER.
        </h1>
        <p className="mt-4 text-lg text-stone-800 dark:text-stone-800 text-center">
      ...
      <div className="w-1/2 relative">
        <Image
          ...
          alt="Gym Background"
        />
        <div className="relative flex justify-center items-center h-full backdrop-blur-sm">
          <motion.div
            className="bg-white dark:bg-gradient-to-br from-stone-700 via-black to-stone-900 bg-opacity-80 backdrop-blur-md p-8 rounded-2xl shadow-lg max-w-md w-full"
